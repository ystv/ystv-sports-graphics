...
import { actionFuncs as footballActionFuncs, actionTypes as footballActionTypes, schema as footballSchema } from "../common/sports/football/index.server";
import koa from "koa";
...
(async () => {
    ...
    for (const router of [makeEventAPI("football", footballSchema, footballActionTypes, footballActionFuncs)]) {
